export const RUN_REASON = {
  ...
  REPEATED_VERIFIER_FINDINGS: "REPEATED_VERIFIER_FINDINGS",
  ...
  WORK_SESSION_IDLE_TIMEOUT: "WORK_SESSION_IDLE_TIMEOUT",
  WORK_SESSION_IDLE_ABORTED: "WORK_SESSION_IDLE_ABORTED",
