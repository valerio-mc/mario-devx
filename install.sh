...
copy_or_fetch "templates/guardrails.md" "templates/guardrails.md" ".mario/guardrails.md"
copy_or_fetch "templates/activity_log.txt" "templates/activity_log.txt" ".mario/activity.log"
copy_or_fetch "templates/errors_log.txt" "templates/errors_log.txt" ".mario/errors.log"
